...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful body shape calculator calculator tool, check it out: https://seosaurus.in/tools/body-shape-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/body-shape-calculator/";
